...
enum AppStrings {
    ...
    static let settingsKeys = [
        ...
        "settings.format.svg", "settings.format.arw", "settings.format.nef"
    ]
    ...
    static let interactionKeys = [
        ...
        "viewer.contextMenu.zoom", "viewer.contextMenu.flip",
        "viewer.contextMenu.showImage", "viewer.contextMenu.showSingleImage",
        "folderBrowser.contextMenu.open", "folderBrowser.contextMenu.move",
        "folderBrowser.contextMenu.copyPaths", "folderBrowser.contextMenu.revealItems",
        "folderBrowser.contextMenu.moveItems", "folderBrowser.contextMenu.renameItems",
        "folderBrowser.contextMenu.trashItems",
